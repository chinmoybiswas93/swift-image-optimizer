...
class Notices {
	...
	public function maybe_render_no_engine_notice() {
		...
		printf(
			...
			esc_html__( 'No image conversion engine was found on this server. Ask your host to enable the GD extension with WebP support, or the Imagick extension. Image optimization is paused until then.', 'swift-image-optimizer' )
		);
	}
}
