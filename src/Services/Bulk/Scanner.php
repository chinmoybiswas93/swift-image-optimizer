...
class Scanner {
	...
	public static function count_pending() {
		...
		$params = array_merge(
			$mimes,
			array( Database::STATUS_OPTIMIZED, Database::STATUS_SKIPPED, Database::STATUS_FAILED )
		);
	...
	public static function count_retryable() {
		...
		$params = array_merge(
			array( Database::STATUS_SKIPPED, Database::STATUS_FAILED ),
			$permanent
		);
